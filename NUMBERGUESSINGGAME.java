 ...
 * PURSPOSE:ENTERTAINMENT AND SMART SKILLS
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (guess == secretNumber) {
                ...
                System.out.println("GIVEN NUMBER IS VERY LESS THAN SECRET NUMBER"+"GUESS ANOTHER NUMBER LESS THAN SECRET NUMBER");
                score1 -= 15; 
            } else {
                System.out.println("GIVEN NUMBER IS HIGHER THAN SECRET NUMBER"+"GUESS ANOTHER NUMBER HIGHER THAN SECRET NUMBER");
                score1 -= 15; 
            }
        ...
        if(score1>100)
        {
            ...
            while (true) {
                ...
                if (guessesCount >= 6) {
                    System.out.println("YOU REACHED THE MAXIMUM NUMBER OF GUSSES IN ROUND TWO"+"GAME OVER"+"TRY AGAIN");
                    System.out.println("THE SECRET NUMBER IS: " + secretNumber);
                    System.out.println("YOUR SCORE IS: 0");
                    break;
                }
